...
## Notas
- Se habilitaron flags de futuro de React Router para preparar v7 y evitar warnings.
- El tamaño inicial de página es 6 recetas (configurable).
- Footer con contactos y logo UTN.
